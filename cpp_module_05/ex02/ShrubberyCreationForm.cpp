...
/*   Updated: 2024/03/21 15:46:24 by fahmadia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm::ShrubberyCreationForm(void) : AForm("Default Target" ,"Shrubbery Form", 145, 137)
{
	return;
}
...
ShrubberyCreationForm::ShrubberyCreationForm(std::string target) : AForm(target, "Shrubbery Form", 145, 137)
{
	return;
}
