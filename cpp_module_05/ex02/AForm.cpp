...
/*   Updated: 2024/03/21 16:45:10 by fahmadia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Form Name: " << form.getName() << "\nForm Required Grade to Sign: " << form.getRequiredGradeToSign() << "\nForm Required Grade to Execute: " << form.getRequiredGradeToExe() << "\nIs Form Signed: " << (form.getIsSigned() ? "true" : "false") << std::endl;
	return cout;
}
