...
/*   Updated: 2024/01/28 10:58:11 by fahmadia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << this->_name << " is created by parameterized constructor." << std::endl;
	return;
}
...
{
	*this = clapTrap;
	std::cout << this->_name << " is created by copy constructor." << std::endl;
	return;
}
...
{
	std::cout << this->_name << " is destroyed by destructor." << std::endl;
	return;
}
